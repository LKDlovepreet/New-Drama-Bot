...
# --- HTML TEMPLATES (Fixed CSS Braces) ---
LOGIN_HTML = """
<!DOCTYPE html>
<html><head><title>Login</title>
<style>
body{{font-family:sans-serif;display:flex;justify-content:center;align-items:center;height:100vh;background:#1e1e1e;color:white}}
...
async def dashboard(request):
    ...
    # Dashboard HTML me koi placeholder nahi hai, to seedha return karein
