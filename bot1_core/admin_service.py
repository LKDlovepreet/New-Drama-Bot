...
async def cancel_process(message: types.Message, state: FSMContext):
    ...
    if current_state is None:
        await message.answer("🛑 <b>Nothing to cancel.</b> Main free hu.")
        return
...
async def save_media_and_get_link(message: types.Message, state: FSMContext):
    # 🛑 AGAR STATE ACTIVE HAI TO IGNORE KARO (Taaki Bulk/Broadcast me interfere na kare)
...
# --- Admin Dashboard Handlers (Back/Premium/Admins) ---
...
# Note: Add/Remove Admin Action handlers and Manage Chat handlers as per previous turn (omitted for brevity but they belong here)
# ... (Previous handlers for adding admins, managing chats remain same)
